        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-6 col-md-2 offset-1">
              <div className="widget widget-links">
                <h5 className="widget-title"> Navigate</h5>
                <ul>
                  <li>
                    <Link
                      className="footer_"
              ...
              <div className="widget widget-text widget-links">
                ...
                <ul>
                  <li>
                    ...
                    <a href={process.env.PUBLIC_URL}>
                      Smart-pet-feeder, NIBM, Kandy
                    </a>
                  </li>
                  <li>
                    <i className="icofont icofont-iphone"></i>
                    <a href="tel:441632960290">+94 12 345 6789</a>
                  </li>
                  <li>
                    <i className="icofont icofont-iphone"></i>
                    <a href="tel:441632960290">+94 12 345 6789</a>
                  ...
                  <li>
                    ...
                    <a href={process.env.PUBLIC_URL}>
                      smartpetfeederNIBM@gmail.com
                    </a>
                  </li>
                  <li>
                    <i className="icofont icofont-globe"></i>
                    <a href={process.env.PUBLIC_URL}>
                      www.smartpetfeedernibm.com
                    </a>
                  </li>
                </ul>
              </div>
